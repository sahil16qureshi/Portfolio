...
export function Hero() {
  return (
    <section id="home" className="relative overflow-hidden py-20 sm:py-24 lg:py-28">
      <div className="section-shell grid items-center gap-12 lg:grid-cols-[1.06fr_0.94fr]">
        <MotionDiv
        ...
        >
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-line bg-white/[0.06] px-4 py-2 text-sm text-slate-300">
            <Rocket className="h-4 w-4 text-cyanSoft" />
        ...
        <MotionDiv
          ...
          className="relative"
        >
          <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-cyanSoft/20 via-transparent to-violetSoft/20 blur-2xl" />
          <ImageFrame
            src="/images/profile.jpeg"
            alt="Sahil Qureshi profile"
            label="public/images/profile.jpeg"
